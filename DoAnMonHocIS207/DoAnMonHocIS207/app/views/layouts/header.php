    ...
    <header class="w-full sticky top-0 z-50 glass-nav shadow-[0_40px_40px_-15px_rgba(25,28,24,0.04)]">
        <div class="flex justify-between items-center px-8 py-6 max-w-7xl mx-auto">
            ...
            <nav class="hidden md:flex gap-8 items-center">
                ...
                <a class="text-[#191c18]/70 dark:text-stone-400 font-['Epilogue'] tracking-tight hover:text-[#4f6636] transition-colors duration-300" href="<?= BASE_URL ?>?url=login">Login</a>
                <a class="text-[#191c18]/70 dark:text-stone-400 font-['Epilogue'] tracking-tight hover:text-[#4f6636] transition-colors duration-300" href="<?= BASE_URL ?>?url=register">Register</a>
            </nav>
            </nav>
            <div class="flex items-center gap-6">
                ...
                <a href="<?= BASE_URL ?>?url=profile" class="material-symbols-outlined text-[#384e21] scale-95 active:opacity-80 transition-transform">account_circle</a>
                <div class="relative">
                    <a href="<?= BASE_URL ?>?url=cart" class="material-symbols-outlined text-[#384e21] scale-95 active:opacity-80 transition-transform">shopping_cart</a>
